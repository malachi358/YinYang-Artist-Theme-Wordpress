...
//---END Split Layout Script! ---//

//---START Navigation Controllers ---//

$(".navlinkLeft a").click(function () {
    $(".pageLeft").fadeOut("slow");
    $($(this).attr("href")).fadeIn("slow");
});

//---END Navigation Controllers ---//


// --- START Foggy JS --- //

$(".gallery-item a").click(function () {
	$('body > *:not(.nivo-lightbox-overlay)').foggy({
...
$('a').nivoLightbox({
    ...
    $('body > *:not(.nivo-lightbox-overlay)').foggy(false);
...
$(".side-right").hover(
  function () {
    $(".svg-holder").show("slow");
  },
  function () {
    $(".svg-holder").hide("fast");
  }
);
// --- END Line Art --- //

// --- START FixTextJS --- //
//$("h1").fitText(); // Turn the compressor down (resizes less aggressively)
